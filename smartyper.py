...
class SmarTyperApp(ctk.CTk):
    def __init__(self):
        ...
        self.icons = {
            "home": os.path.join(self.home_path, "images", "home_24dp_E8EAED.png"),
            "genotype": os.path.join(self.home_path, "images", "Blue_genotyping.png"),
            "exit": os.path.join(self.home_path, "images", "1564506_close_exit_logout_power_icon.png")
        }
        ...
        self.pages = {
            ...
            "openner": project_loader(self.right_panel)
        }
    ...
    def create_tabs(self):
        ...
        for tab_name in self.tab_names:
            ...
            if tab_icon_path:
                try:
                    ...
                    tab_icon = ImageTk.PhotoImage(tab_image)  # Use ImageTk.PhotoImage
                except IOError:
        ...
        if exit_icon_path:
                try:
                    ...
                    exit_icon = ImageTk.PhotoImage(exit_image)  # Use ImageTk.PhotoImage
                except IOError:
