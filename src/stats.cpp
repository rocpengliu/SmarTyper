...
void Stats::print() {
    ...
    std::cout << "total reads: " << mReads << std::endl;
    std::cout << "total bases: " << mBases << std::endl;
    std::cout << "Q20 bases: " << mQ20Total << "(" << (mQ20Total*100.0)/mBases << "%)" << std::endl;
    std::cout << "Q30 bases: " << mQ30Total << "(" << (mQ30Total*100.0)/mBases << "%)" << std::endl;
}

void Stats::reportJson(ofstream& ofs, string padding) {
    ofs << "{" << std::endl;

    ofs << padding << "\t" << "\"total_reads\": " << mReads << "," << std::endl;
    ofs << padding << "\t" << "\"total_bases\": " << mBases << "," << std::endl;
    ofs << padding << "\t" << "\"q20_bases\": " << mQ20Total << "," << std::endl;
    ofs << padding << "\t" << "\"q30_bases\": " << mQ30Total << "," << std::endl;
    ofs << padding << "\t" << "\"total_cycles\": " << mCycles << "," << std::endl;

    // quality curves
    string qualNames[5] = {"A", "T", "C", "G", "mean"};
    ofs << padding << "\t" << "\"quality_curves\": {" << std::endl;
    for(int i=0 ;i<5; i++) {
    ...
    ofs << padding << "\t" << "\"content_curves\": {" << std::endl;
    for(int i=0 ;i<6; i++) {
