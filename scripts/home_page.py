...
def create_home(parent):
    ...
    # Header Labels
    header_label1 = ctk.CTkLabel(header_frame, text="Welcome to SmarTyper!", font=("Arial", 45, "bold"),
    ...
    header_label2 = ctk.CTkLabel(header_frame, text="A smart platform for genotyping and comprehensive data statistics and visualization!",
                                 font=("Arial", 25, "bold"), fg_color="#3b3b3b", text_color="green")
    header_label2.pack(pady=(5, 5), padx=(50, 10), anchor="center")

    header_label3 = ctk.CTkLabel(header_frame, text="--powered by Bioinforlligence", font=("Arial", 15, "bold"),
                                 fg_color="#3b3b3b", text_color="green")
    header_label3.pack(pady=(5, 20), padx=(50, 20), anchor="center")

    # Place buttons side by side within the content_frame
    size = 100
    data_loader_btn = ctk.CTkButton(content_frame, text="Genotype", width=size*2, height=size, font=("Arial", 30, "bold"),
                                    command=lambda: parent.master.show_page("genotype"))
    data_loader_btn.grid(row=0, column=0, padx=(50, 25), pady=(10, 10), sticky="e")

    project_openner_btn = ctk.CTkButton(content_frame, text="Microtype", width=size*2, height=size, font=("Arial", 30, "bold"),
                                        command=lambda: parent.master.show_page("microtype"))
    project_openner_btn.grid(row=0, column=1, padx=(50, 25), pady=(10, 10), sticky="w")
    
    microtype_btn = ctk.CTkButton(content_frame, text="Project", width=size*2, height=size, font=("Arial", 30, "bold"),
